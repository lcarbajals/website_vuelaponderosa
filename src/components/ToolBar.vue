                    ...
                    <div class="text-nowrap">
                        <div class="d-flex justify-content-between">
                            <div class="d-inline-block float-start">
                                <ul class="list-inline m-0">
                                    <li class="dropdown list-inline-item">
                                        <a v-for="(val, key) in redes_sociales" :key="key" :href="val.url" class="fs--14 pt-2 pr-1 pe-1 pb-0  d-inline-block font-weight-medium  ">
                                            <i class="float-start  fi " :class="[val.icono]"></i>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="d-inline-block float-end">
                                <ul class="list-inline m-0">
                                    <li class="dropdown list-inline-item">
                                        <a href="javascript:void(0)" class="fs--14 pt-2 pr-1 pe-1 pb-0 d-inline-block font-weight-medium ">
                                        <i class="float-start fi fi-phone"></i> (+51){{empresa.telefonos}}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light justify-content-lg-between justify-content-md-inherit">
                    <div class="align-items-start">
                        ...
                        <router-link class="navbar-brand" :to="'/'">
                            <img :src="empresa.path_file_image" width="178" height="68" alt="..." style="max-width:180px !important;"  >
                        </router-link>
                    </div>
